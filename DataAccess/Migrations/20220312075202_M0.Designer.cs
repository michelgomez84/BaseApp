...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModel.PurchaseOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataModel.PurchaseOrderProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataModel.PurchaseOrderProduct", b =>
                {
                    b.HasOne("DataModel.Product", "Product")
                        .WithOne()
                        .HasForeignKey("DataModel.PurchaseOrderProduct", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataModel.PurchaseOrder", "PurchaseOrder")
                        .WithMany("LProducts")
